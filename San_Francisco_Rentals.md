...
From the Data Frame above, we can see that values in `the_geom` and
...
![](Figs/unnamed-chunk-9-1.png)<!-- --> <br> From the heatmap, we see a
large range of average rental prices within the counties, with Solano
having the cheapest average rental prices of around \$2,000 USD, and
Napa and Marin having average rental prices of around \$4,000 USD. Using
Compass’s estimation of the cost of living within each San Francisco
county in 2018, the average rental prices are linearly related to the
relative cost of living for each county. However, there is a notable
exception with Marin county, having both the second lowest cost of
living according to Compass, but the second highest average house rental
prices.
...
![](Figs/unnamed-chunk-10-1.png)<!-- --> <br> The second graph shows a
decreasing trend of rental prices as the number of beds in a rental
increases. The graph also shows the average numbers of beds in a rental
in each county, as well as the average rental price. Although most
counties follow this overall trend, we do see 2 outliers in Marin county
and Napa county. Despite offering the average or above average number of
beds in a rental house, both counties have the highest and second
highest average rental prices respectively.
...
Increases in the price of property rental is not simply about the size
